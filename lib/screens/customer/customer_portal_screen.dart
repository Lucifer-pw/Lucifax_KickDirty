...
class CustomerPortalScreen extends StatefulWidget {
  CustomerPortalScreen({Key? key}) : super(key: key);
...
class _CustomerPortalScreenState extends State<CustomerPortalScreen> {
    ...
    if (categories.isEmpty) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Kategori layanan tidak tersedia. Silakan hubungi admin.')),
        );
      }
      return;
    }
                    ...
                    children: [
                                         ...
                                         if (selectedService != null)
                                           Padding(
                                             ...
                                             child: Text(
                                               ...
                                               style: TextStyle(fontSize: 11, color: AppTheme.textGray, fontStyle: FontStyle.italic),
                                             ),
                                           ),
                                       ],
                                     );
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton.icon(
                                onPressed: () {
                                  ...
                                  if (name.isEmpty) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(content: Text('Masukkan nama / merk barang terlebih dahulu')),
                                    );
                                    return;
                                  }
                                  if (selectedService == null) {
                                ...
                                label: Text('Tambahkan Barang ke Daftar', style: TextStyle(color: Colors.white)),
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Card(
                                ...
                                child: ListTile(
                                  ...
                                  title: Text(item.itemName, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                                  subtitle: Text('${item.categoryName} - ${item.serviceName}', style: TextStyle(color: AppTheme.textGray, fontSize: 10)),
                                  trailing: Row(
                                    mainAxisSize: MainAxisSize.min,
                                    children: [
                                      Text(
                        ...
                        children: [
                          Expanded(
                            child: OutlinedButton.icon(
                              ...
                              icon: Icon(Icons.camera_alt_outlined, color: AppTheme.primaryBlue, size: 18),
                              label: Text('Kamera', style: TextStyle(color: AppTheme.primaryBlue, fontSize: 12)),
                          ...
                          Expanded(
                            child: OutlinedButton.icon(
                              ...
                              icon: Icon(Icons.photo_outlined, color: AppTheme.primaryBlue, size: 18),
                              label: Text('Galeri', style: TextStyle(color: AppTheme.primaryBlue, fontSize: 12)),
                              style: OutlinedButton.styleFrom(
                                side: BorderSide(color: AppTheme.primaryBlue),
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                                padding: EdgeInsets.symmetric(vertical: 8),
                      ...
                      if (orderItems.isNotEmpty || (nameController.text.trim().isNotEmpty && selectedService != null)) ...[
                        ...
                        Row(
                          ...
                          children: [
                            Text('Harga Layanan:', style: TextStyle(fontSize: 13, color: AppTheme.textGray)),
                            Text(
                        ...
                        if (deliveryFee > 0) ...[
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text('Rp ${deliveryFee.toStringAsFixed(0).replaceAllMapped(RegExp(r"(\d{1,3})(?=(\d{3})+(?!\d))"), (Match m) => "${m[1]}.")}', style: TextStyle(fontSize: 13)),
                            ],
                          ),
                        ],
                        if (usePointsRedemption) ...[
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Text('-Rp ${discountValue.toStringAsFixed(0).replaceAllMapped(RegExp(r"(\d{1,3})(?=(\d{3})+(?!\d))"), (Match m) => "${m[1]}.")}', style: TextStyle(fontSize: 13, color: Colors.green, fontWeight: FontWeight.bold)),
                            ],
                          ),
                        ],
                        if (voucherDiscount > 0) ...[
                          ...
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Text('Diskon Voucher:', style: TextStyle(fontSize: 13, color: Colors.green)),
                              Text('-Rp ${voucherDiscount.toStringAsFixed(0).replaceAllMapped(RegExp(r"(\d{1,3})(?=(\d{3})+(?!\d))"), (Match m) => "${m[1]}.")}', style: TextStyle(fontSize: 13, color: Colors.green, fontWeight: FontWeight.bold)),
                            ],
                          ),
                        ],
                        SizedBox(height: 8),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            Text('Total Pembayaran:', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
                            Text(
                          ...
                          onPressed: isSubmitting
                              ...
                              : () async {
                                  try {
                                    ...
                                    if (orderItems.isEmpty) {
                                      ScaffoldMessenger.of(context).showSnackBar(
                                        SnackBar(content: Text('Tambahkan minimal 1 barang ke daftar pesanan')),
                                      );
                                      return;
                                    }
      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setStateDialog) {
            return AlertDialog(
              title: Text('Pembayaran QRIS (Cashless)', textAlign: TextAlign.center),
                  ...
                  children: [
                    ...
                    Image.asset(
                      ...
                      errorBuilder: (context, error, stackTrace) => Container(
                        height: 120,
                        color: AppTheme.lightGray,
                        child: Center(child: Icon(Icons.qr_code, size: 60, color: AppTheme.textGray)),
                      ),
                    ),
                    SizedBox(height: 12),
                    Text(
                        ...
                        children: [
                          Expanded(
                            child: OutlinedButton.icon(
                              ...
                              label: Text('Kamera', style: TextStyle(fontSize: 11)),
                              style: OutlinedButton.styleFrom(
                                padding: EdgeInsets.symmetric(vertical: 8),
                              ),
                            ),
                          ...
                          Expanded(
                            child: OutlinedButton.icon(
                              ...
                              label: Text('Galeri', style: TextStyle(fontSize: 11)),
                              style: OutlinedButton.styleFrom(
                                padding: EdgeInsets.symmetric(vertical: 8),
                              ),
                            ),
              ...
              actions: [
                if (isUploading)
                  ...
                  ElevatedButton.icon(
                        ...
                        : () async {
                            ...
                            try {
                              ...
                              if (context.mounted) {
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(content: Text('Bukti pembayaran berhasil diunggah! Menunggu verifikasi dari toko.')),
                                );
                              }
                            } catch (e) {
                              if (context.mounted) {
                    ...
                    label: Text('Kirim Bukti Pembayaran'),
                  ),
                  TextButton(
                    onPressed: () {
                      Navigator.pop(context); // Close dialog
                    },
                    child: Text('Tutup', style: TextStyle(color: AppTheme.textGray)),
                  ),
                ],
              ],
            );
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                // Normalize phone
                String newPhone = rawPhone.replaceAll(RegExp(r'[^0-9]'), '');
        ...
        children: [
          ...
          Card(
            child: Padding(
              ...
              child: Column(
                children: [
                  ListTile(
                    leading: Icon(Icons.person_outline, color: AppTheme.primaryBlue),
                    title: Text('Nama Lengkap', style: TextStyle(fontSize: 11, color: AppTheme.textGray)),
                    subtitle: Text(user.name, style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: AppTheme.darkBlueText)),
                    trailing: IconButton(
                  ...
                  Divider(height: 1),
                  ListTile(
                    leading: Icon(Icons.phone_android_outlined, color: AppTheme.primaryBlue),
                    title: Text('Nomor WhatsApp', style: TextStyle(fontSize: 11, color: AppTheme.textGray)),
                    subtitle: Text(user.phoneNumber, style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: AppTheme.darkBlueText)),
                  ),
                  Divider(height: 1),
                  ListTile(
                    leading: Icon(Icons.email_outlined, color: AppTheme.primaryBlue),
                    title: Text('Email', style: TextStyle(fontSize: 11, color: AppTheme.textGray)),
                    subtitle: Text(user.email, style: TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: AppTheme.darkBlueText)),
                  ),
                  Divider(height: 1),
                  ListTile(
                    leading: Icon(Icons.home_outlined, color: AppTheme.primaryBlue),
                    title: Text('Detail Alamat', style: TextStyle(fontSize: 11, color: AppTheme.textGray)),
                    subtitle: Text(
                  ...
                  ListTile(
                    ...
                    title: Text('Titik Google Maps', style: TextStyle(fontSize: 11, color: AppTheme.textGray)),
                    subtitle: Text(
              ...
              builder: (context, themeProvider, child) {
                return Column(
                  children: [
                    ...
                    RadioListTile<ThemeMode>(
                      title: Text('Default Perangkat (HP)'),
          ...
          SizedBox(
            ...
            child: OutlinedButton.icon(
              ...
              label: Text('Keluar Aplikasi', style: TextStyle(color: Colors.red)),
              style: OutlinedButton.styleFrom(
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.account_circle_outlined, size: 80, color: AppTheme.textGray),
            SizedBox(height: 16),
            Text(
              'Belum Masuk Akun',
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text('Masuk / Daftar', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          title: Text('Silakan Masuk', style: TextStyle(fontWeight: FontWeight.bold)),
          content: Text('Anda harus masuk atau membuat akun terlebih dahulu untuk melakukan pemesanan layanan.'),
          actions: [
            TextButton(
              onPressed: () => Navigator.pop(context),
  ...
  Widget _buildServiceMenuTab(BuildContext context, bool isLoggedIn) {
    return StreamBuilder<List<CategoryModel>>(
      ...
      builder: (context, catSnapshot) {
        ...
        if (categories.isEmpty) {
          return Center(child: Text('Belum ada kategori layanan.'));
        }
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    ElevatedButton(
                                      ...
                                      child: Text('Pesan', style: TextStyle(color: Colors.white, fontSize: 12)),
                                    ),
                                  ],
                                ),
                              ),
  ...
  Widget _buildStatCard(String value, String label, IconData icon, Color color) {
    return Column(
      children: [
        ...
        SizedBox(height: 6),
        Text(value, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: AppTheme.darkBlueText)),
        SizedBox(height: 2),
        Text(label, style: TextStyle(fontSize: 10, color: AppTheme.textGray)),
      ],
    );
  }
        ...
        children: [
          ...
          ...order.items.map((item) => Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  item.serviceName,
                  style: TextStyle(fontSize: 9, color: AppTheme.textGray, fontWeight: FontWeight.w500),
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                ),
              ],
          ...
          Expanded(
            child: Text(
              ...
              style: TextStyle(fontSize: 12, color: AppTheme.darkBlueText, fontStyle: FontStyle.italic),
              maxLines: 4,
              overflow: TextOverflow.ellipsis,
            ),
          ),
                ...
                children: [
                  if (mapsUrl.isNotEmpty) ...[
                    Expanded(
                      child: ElevatedButton.icon(
                        ...
                        label: Text('Petunjuk Maps', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                      ),
                    ),
                    SizedBox(width: 12),
                  ],
                  Expanded(
                    child: ElevatedButton.icon(
                      ...
                      label: Text('Hubungi WA', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                    ),
                  ),
                ],
              ),
              Divider(height: 48, color: Colors.white24),
              Center(
                child: Text(
    ...
    return Scaffold(
      appBar: showAppBar
          ...
          : (currentUser == null && _currentIndex == 0
              ? AppBar(
                  title: Text('KickDirty Menu Layanan'),
                  automaticallyImplyLeading: false,
                )
              : null),
      body: IndexedStack(
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4),
                    Text(user.email, style: TextStyle(color: AppTheme.textGray, fontSize: 12)),
                    if (user.phoneNumber.isNotEmpty) ...[
                      SizedBox(height: 2),
                      Text('WA: +${user.phoneNumber}', style: TextStyle(color: AppTheme.textGray, fontSize: 12)),
                    ],
                  ],
                ),
              ),
  ...
  Widget _buildEmptyState(String message) {
    return Container(
      ...
      child: Column(
        children: [
          Icon(Icons.info_outline, color: AppTheme.textGray, size: 32),
          SizedBox(height: 8),
          Text(
            message,
            textAlign: TextAlign.center,
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text(
                  order.id,
                  style: TextStyle(fontWeight: FontWeight.bold, color: AppTheme.primaryBlue, fontSize: 15),
                ),
                Text(formattedDate, style: TextStyle(color: AppTheme.textGray, fontSize: 11)),
              ],
            ),
            ...
            ...order.items.map((item) => Padding(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(item.itemName, style: TextStyle(fontWeight: FontWeight.w600, fontSize: 13)),
                      Text(item.serviceName, style: TextStyle(color: AppTheme.textGray, fontSize: 12)),
                    ],
                  ),
                )),
            ...
            Row(
              ...
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Total Biaya', style: TextStyle(color: AppTheme.textGray, fontSize: 10)),
                    Text(
            ...
            if (order.status == 'belum_bayar') ...[
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  ...
                  label: Text('Bayar Sekarang (QRIS)', style: TextStyle(fontSize: 12)),
                  style: OutlinedButton.styleFrom(
      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setStateDialog) {
            return AlertDialog(
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
              title: Text('Beri Ulasan & Rating', style: TextStyle(fontWeight: FontWeight.bold)),
              content: SingleChildScrollView(
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    ...
                    Text(
                      ...
                      textAlign: TextAlign.center,
                      style: TextStyle(fontWeight: FontWeight.w600, color: AppTheme.darkBlueText),
                    ),
                    SizedBox(height: 16),
                      ...
                      Row(
                        ...
                        children: [
                          if (order.photoBefore.isNotEmpty)
                            Column(
                              children: [
                                Text('Before', style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: AppTheme.textGray)),
                                SizedBox(height: 4),
                                SizedBox(
                                  width: 70,
                                  height: 70,
                          ...
                          if (order.photoAfter.isNotEmpty)
                            Column(
                              children: [
                                Text('After', style: TextStyle(fontSize: 10, fontWeight: FontWeight.bold, color: AppTheme.textGray)),
                                SizedBox(height: 4),
                                SizedBox(
                                  width: 70,
                                  height: 70,
              ...
              actions: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ...
                    if (context.mounted) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(content: Text('Terima kasih atas ulasan Anda!')),
                      );
                    }
                  },
                  style: ElevatedButton.styleFrom(backgroundColor: AppTheme.primaryBlue),
        ...
        child: Column(
          ...
          children: [
            ListTile(
              ...
              title: Text(order.id, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
              subtitle: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(
                  ...
                  Text(formattedDate, style: TextStyle(fontSize: 10, color: AppTheme.textGray)),
                ],
              ),
              trailing: Text(
                'Rp ${order.totalAmount.toStringAsFixed(0).replaceAllMapped(RegExp(r'(\d{1,3})(?=(\d{3})+(?!\d))'), (Match m) => '${m[1]}.')}',
            ...
            if (order.rating != null) ...[
              ...
              Row(
                children: [
                  Text('Penilaian Anda: ', style: TextStyle(fontSize: 11, color: AppTheme.textGray)),
                  Row(
                    children: List.generate(5, (index) {
                      return Icon(
              ...
              Align(
                ...
                child: TextButton.icon(
                  ...
                  label: Text('Beri Ulasan & Rating', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold)),
                ),
              ),
            ],
          ],
